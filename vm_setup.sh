...
echo ""
echo "      bash vm_run.sh                  # pipeline + demo + recorder"
echo "      bash vm_run.sh --bench          # + benchmark full"
echo "      bash vm_run.sh --bench=quick    # + benchmark quick (~3 phút)"
echo ""
...
echo "      bash test_smoke.sh             # kiểm tra"
